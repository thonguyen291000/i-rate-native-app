...
public class RestaurantActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_EMAIL = "com.example.application.rentalz.Email";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentCreate = new Intent(RestaurantActivity.this, NewRestaurantActivity.class);
                intentCreate.putExtra("email", email);
    ...
    private void showList() {
        ...
        //Get restaurants
        Query query = restaurantsRef.orderBy("dateCreate", Query.Direction.DESCENDING);
                ...
                builder.setMessage("Do you want to delete this restaurant ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Toast.makeText(RestaurantActivity.this, "Delete successful!", Toast.LENGTH_SHORT).show();
                        ...
                        .setNegativeButton("No", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                dialog.cancel();
                                startActivity(new Intent(RestaurantActivity.this, RestaurantActivity.class));
                            }
                        });
                //Creating dialog box
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //Set up search item on menu to menu item and get view
        MenuItem searchItem = menu.findItem(R.id.action_search);
        SearchView searchView = (SearchView) searchItem.getActionView();

        //Delete search icon on keyboard
        searchView.setImeOptions(EditorInfo.IME_ACTION_DONE);

        //Action when text in search changed
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            @Override
            public boolean onQueryTextSubmit(String query) {
                Intent intent = new Intent(RestaurantActivity.this, ResultSearchActivity.class);

                if(query.isEmpty()) {
                    Toast.makeText(RestaurantActivity.this, "You need type some letters to search", Toast.LENGTH_SHORT).show();
                } else {
                    intent.putExtra("constraint", query);
                    startActivity(intent);
                }
                return false;
            }
